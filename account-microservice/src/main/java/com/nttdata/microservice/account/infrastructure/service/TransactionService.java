...
import com.nttdata.microservice.account.domain.model.Transaction;
import com.nttdata.microservice.account.domain.repository.AccountRepository;
import com.nttdata.microservice.account.domain.repository.TransactionRepository;
...
import com.nttdata.microservice.account.common.exception.InsufficientBalanceException;
...
@Service
public class TransactionService implements com.nttdata.microservice.account.application.usecase.TransactionService {
